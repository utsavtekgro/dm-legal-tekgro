<?php
/**
 * Site header: document head (wp_head), top bar, logo, nav, mobile menu,
 * search overlay. Ported 1:1 from the legacy static header.php; the only
 * changes are wp_head()/wp_body_open() and reading nav data from globals.
 *
 * @package DM_Legal
 * @since   1.0.0
 */
...
global $navLinks, $lawLinks;
$navLinks = $navLinks ?? array();
$lawLinks = $lawLinks ?? array();
?>
<!DOCTYPE html>
